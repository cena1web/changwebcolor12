...
$( ".cloud-label-widget-content .label-size, #scroll, .pagenav a, #btn-7a, .nightmode #btn-7a, .nightmode .cenaweb .check:checked~.iconmode .closemode, .cenaweb .iconmode .openmode" ).mouseover(function() {
  $( ".cloud-label-widget-content .label-size:hover, .pagenav a:hover" ).css("background-color", idColor);
  $( ".cloud-label-widget-content .label-size:hover span, #btn-7a:hover, .cenaweb .iconmode .openmode:hover, .nightmode .cenaweb .check:checked~.iconmode .closemode:hover, .nightmode #btn-7a:hover, #scroll:hover" ).css("background-color", "#48494d");});
$(".cloud-label-widget-content .label-size, #scroll, #btn-7a, .nightmode #btn-7a:hover, .cenaweb .iconmode .openmode, .nightmode .cenaweb .check:checked~.iconmode .closemode, .pagenav a").mouseout(function(){
  $(".cloud-label-widget-content .label-size").css("background-color", "#f5f5f5");
  $(".pagenav a").css("background-color", "#48494d");
  $(".cloud-label-widget-content .label-size span, #scroll, #btn-7a, .nightmode #btn-7a:hover, .nightmode .cenaweb .check:checked~.iconmode .closemode, .cenaweb .iconmode .openmode").css("background-color", idColor);});;
...
$(".top-bar-social #social a").mouseout(function(){ $(".top-bar-social #social a").css("background-color", idColor);});;
 ...
 $(".top-bar, .gg, #privcy").css("border-color", idddColor);  
